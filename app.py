import os
from flask import Flask, render_template, request, jsonify, url_for, redirect, session, flash, g
...
def api_gen_list_token():
    ...
    for x in list_cookies :
        ...
        list_token.append({"cookies":x,"token":find_token.group(1)})
